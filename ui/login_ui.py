...
def setUp_Login(login_frame, register_frame, user_dashboard_frame, admin_dashboard_frame, shared_data):
    ...
    user_login_button = tk.Button(login_frame, text="User Login", font=("Arial", 16, "bold"), 
    ...
    admin_login_button = tk.Button(login_frame, text="Admin Login", font=("Arial", 16, "bold"), 
                                    bg="#4CAF50", fg="white", width=20, height=2,
    ...
    register_button = tk.Button(login_frame, text="Register", font=("Arial", 16, "bold"), 
                                 bg="#4CAF50", fg="white", width=20, height=2, 
